...
def create_app(
    ...
    provider_runtime = build_provider_runtime(resolved_config, provider=provider)
    app.state.provider_registry = provider_runtime.registry
    app.state.provider = provider_runtime.active_provider
