"""Оркестрация direct-генерации с ограниченной поддержкой repair."""
...
class DirectGenerationOrchestrator:
    ...
    def generate(self, document_id: str, generation_request: GenerationRequest) -> GenerationResult:
        ...
        try:
            direct_response, direct_prompt_version, provider_request_summary = self._run_pipeline_step(
    ...
    def _build_partial_quiz(
        ...
        *,
        ...
        """Нормализовать ответ провайдера без строгой проверки качества."""
    ...
    def _log_pipeline_step(
        *,
        ...
        """Выпустить одно структурированное событие шага pipeline генерации."""
