...
Фотосинтез делится на два этапа: световые реакции и тёмновые реакции (цикл Кальвина). В световых реакциях энергия фотонов улавливается хлорофиллом и преобразуется в химическую энергию АТФ и НАДФН. Одновременно происходит фотолиз воды: молекулы H₂O расщепляются, высвобождая кислород как побочный продукт. В цикле Кальвина, протекающем в строме хлоропласта, АТФ и НАДФН используются для фиксации CO₂ и синтеза трёхуглеродных сахаров, из которых затем образуется глюкоза.

Интенсивность фотосинтеза зависит от нескольких факторов: освещённости, концентрации углекислого газа, температуры и наличия воды. При недостатке любого из них скорость процесса снижается. Например, при высокой освещённости, но малом количестве CO₂ растение не сможет использовать всю доступную световую энергию. Именно поэтому в теплицах нередко повышают концентрацию CO₂ для увеличения урожайности.`;
