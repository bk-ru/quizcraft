...
const VALIDATION_MESSAGE_RULES = [
  ...
  [/^matching question must have at least four pairs/i, () => "Модель не смогла корректно оформить вопрос на соответствие. Попробуйте повторить генерацию или убрать тип «Соответствие»."],
